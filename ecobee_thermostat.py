...
benign=pd.read_csv('nbaiot-dataset/2.benign.csv')
g_c=pd.read_csv('nbaiot-dataset/2.gafgyt.combo.csv')
g_j=pd.read_csv('nbaiot-dataset/2.gafgyt.junk.csv')
g_s=pd.read_csv('nbaiot-dataset/2.gafgyt.scan.csv')
g_t=pd.read_csv('nbaiot-dataset/2.gafgyt.tcp.csv')
g_u=pd.read_csv('nbaiot-dataset/2.gafgyt.udp.csv')
m_a=pd.read_csv('nbaiot-dataset/2.mirai.ack.csv')
m_sc=pd.read_csv('nbaiot-dataset/2.mirai.scan.csv')
m_sy=pd.read_csv('nbaiot-dataset/2.mirai.syn.csv')
m_u=pd.read_csv('nbaiot-dataset/2.mirai.udp.csv')
m_u_p=pd.read_csv('nbaiot-dataset/2.mirai.udpplain.csv')


#creating sample from the population for equal distribution of classes
...
m_sc=m_sc.sample(frac=0.4,replace=False)
m_sy=m_sy.sample(frac=0.15,replace=False)
m_u=m_u.sample(frac=0.1,replace=False)
m_u_p=m_u_p.sample(frac=0.15,replace=False)
...
x_train_st, x_test_st, y_train_st, y_test_st = train_test_split(
    data.values, target, test_size=0.25, random_state=0)
...
x_train_st, x_test_st, y_train_st, y_test_st = train_test_split(
    train_data_st, target, test_size=0.25, random_state=42)
...
x_train_st, x_test_st, y_train_st, y_test_st = train_test_split(
    train_data_st, target, test_size=0.25, random_state=0)
